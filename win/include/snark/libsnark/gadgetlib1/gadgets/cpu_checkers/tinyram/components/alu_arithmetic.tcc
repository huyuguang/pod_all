...
void ALU_smul_gadget<FieldT>::generate_r1cs_witness()
{
    ...
    */
    ...
    size_t topval = this->pb.val(top).as_integer();
...
void ALU_divmod_gadget<FieldT>::generate_r1cs_witness()
{
    ...
    else
    {
        ...
        const size_t A = this->pb.val(this->arg1val.packed).as_integer();
        const size_t B = this->pb.val(this->arg2val.packed).as_integer();
    ...
    */
    ...
    for (size_t i = 0; i < logw; ++i)
    {
        this->pb.val(barrel_right_internal[i+1]) =
            ...
            FieldT(this->pb.val(barrel_right_internal[i]).as_integer() >> (i+1));

        shifted_out_bits[i].fill_with_bits_of_ulong(this->pb, this->pb.val(barrel_right_internal[i]).as_integer() % (2u<<i));
    }
